...
--
-- Đang đổ dữ liệu cho bảng `ctphieu_nhap`
--
...
ALTER TABLE `phieu_phat`
  ...
  ADD KEY `MaCTPhieuTra` (`MaPhieuTra`),
  ADD KEY `MaDG` (`MaDG`);
...
--
ALTER TABLE `ctphieu_tra`
  ADD CONSTRAINT `ctphieu_tra_ibfk_1` FOREIGN KEY (`MaPhieuTra`) REFERENCES `phieu_tra` (`MaPhieuTra`);
...
ALTER TABLE `phieu_phat`
  ...
  ADD CONSTRAINT `phieu_phat_ibfk_3` FOREIGN KEY (`MaPhieuTra`) REFERENCES `phieu_tra` (`MaPhieuTra`);
